	...
	<div class="main-content">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1" style="overflow: scroll; background-color: #197da4e5;color: white;">
					<ul class="nav" id="side-menu">
						<li>
							<a href="#"><i class="fa fa-file nav_icon"></i>Doctor<span class="fa arrow"></span></a>
						...
						<li>
							<a href="#"><i class="fa fa-book nav_icon"></i>Health Insurance<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="add_insurance.php">Insurance </a>
								</li>
								
							</ul>
						</li>
						<li>
							<a href="#"><i class="fa fa-book nav_icon"></i>Patient<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="patient_list.php">Patient List</a>
								</li>
								<li>
									<a href="appointment_list.php">Appointment Details</a>
								</li>
							</ul>
						</li>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="logo">
					<a href="#">
						<h1 style="letter-spacing: 2px;">Hospital</h1>
