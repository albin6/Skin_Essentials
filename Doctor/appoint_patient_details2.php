...
<div id="page-wrapper">
    <div class="main-page">
        <div class="forms">
            ...
            <h3 class="title1">Appointment List</h3>
    ...
    <div class="form-title">
            ...
            <form action="appoint_patient_details2.php" method="post" id="myform" class="row g-3">
