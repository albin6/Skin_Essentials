...
JQUERY4U.UTIL.setupFormValidation();
            ...
            <?php
             ...
             $pid= $_POST['patient_id'];
              $sql="select distinct p.*,d.*, a.patient_login_id from tbl_appointment as a inner join   tbl_doctor as d on a.doctor_login_id =d.login_id inner join tbl_hospital as h on h.login_id=d.hospital_login_id inner join tbl_medical_speciality as m  on m.medical_speciality_id=d.medical_speciality_id inner join tbl_patient as p on p.login_id=a.patient_login_id  where  a.doctor_login_id=$logid  and a.patient_login_id='$pid'";
                  ...
                  while ($rt=  mysqli_fetch_array($qt))
                    ...
                    <tr>
                                              ...
                                              <td><?php echo $count;?></td>
                                                ...
                                                <td> <a href="view_prescription_by_patient_id.php?id=<?php echo $rt['patient_login_id'];?>" class="btn btn-success">View Prescription</a></td>
