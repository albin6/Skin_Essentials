                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="hospital_registration.php" class="dropdown-item">Hospital Registration</a>
                                <a href="patient_registration.php" class="dropdown-item">Patient Registration</a>
